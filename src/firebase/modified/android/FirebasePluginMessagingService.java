...
public class FirebasePluginMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        try {
            ...
            semusi.ruleengine.pushmanager.SdkFcmListenerService obj = new semusi.ruleengine.pushmanager.SdkFcmListenerService();
            obj.onMessageReceived(remoteMessage, getApplicationContext());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
